...
/**
 * Standalone Roboflow Oil Spill Segmentation Script
 * Usage: node backend/scripts/segment_oil_spill.js [path_to_image.jpg]
 */
...
if (!fs.existsSync(imagePath)) {
  ...
  console.log("Usage: node backend/scripts/segment_oil_spill.js <path_to_image.jpg>");
  process.exit(1);
}
...
fetch("https://serverless.roboflow.com/oil-spill-segmentation/3", {
  ...
  .then((data) => {
    console.log("Response from Roboflow:", JSON.stringify(data, null, 2));
  })
  .catch((error) => {
